...
const AddTask: FC = () => {
    ...
    <div>
      ...
      {/* project code + project name should be an existing active project */}
        ...
        <div className="flex flex-wrap -mx-3 mb-6">
            ...
            <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder="Enter a Task ID" />
            ...
            <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" placeholder="Enter a task name" />
            </div>
        </div>
    ...
    <div className="flex flex-wrap -mx-3 mb-6">
        <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
          ...
          <label htmlFor="startDate" className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Planned Start Date -  Cannot be before the project start date </label>
          <input
            type="Date"
            name="startDate"
            required
        ...
        <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
            {/* start date cannot be before the start date of the project */}
          <label htmlFor="startDate" className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Planned End Date -  Cannot be after the project start date </label>
          <input
            type="Date"
            name="startDate"
            required
